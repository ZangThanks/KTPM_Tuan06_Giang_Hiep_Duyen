...
export default function Cart() {
    ...
    const handleCheckout = async () => {
        ...
        try {
            // TODO: Thay bằng API thật của bạn (POST /api/orders hoặc /api/orders/create)
            const orderData = {
                ...
                shippingAddress: 'Công ty nội bộ',
            };
            ...
            // Tạo order giả lập nếu API không available
            console.log('⚠️ Dùng order giả lập (demo mode)');
